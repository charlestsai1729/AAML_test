...
- [Set up CFU-Playground environment. -20%](#CFU-Playground-Environment-Setup--20%)
- [Porting KWS model into CFU-Playground. -60%](#Porting-KWS-model--60%)
- [Measuring how much MAC and DRAM space of KWS model use. -20%](#Measuring-how-much-MAC-and-DRAM-space-of-KWS-model-use.--20%)
...
### 4. Install Toolchain ([Option 4d: Install/Use Vivado](https://cfu-playground.readthedocs.io/en/latest/vivado-install.html))

[Vivado 2020.1 Download page](https://www.xilinx.com/support/download/index.html/content/xilinx/en/downloadNav/vivado-design-tools/archive.html)

::: info
:bulb: Note that the software can take up to 8 hours to     download, so plan to do that ahead of time.
:::
...
Add ```#include &#34;models/my_cycles.h&#34;``` at the top of the file. Use the functions in ```models/my_cycles.h``` to print the total cycles of MAC operations.
...
$ make load
```
![](https://hackmd.io/_uploads/ryOIodzkT.png)
